  ...
  return (
    <>
      ...
      <div className="card">
        ...
        {[
          { emoji: "⭐", name: "Premium", price: "$2/mo · $15/yr", unlocks: "1,500-char limit · SuggestionZ 😉 · 400MB uploads / 5GB storage · LabelZ + contracts · 8 glow colors · dev tax drops to 5% · games in any language except C++", cta: "Upgrade to Premium", to: "membership" },
          { emoji: "📊", name: "StatZ", price: "$4/mo · $19/yr", unlocks: "5,000-char limit · Automations 🤖 + CallZ ☎️ · 4GB uploads / 100GB storage · SpecZ marketplace · C++/Unreal games · dev tax drops to 3% · includes everything in Premium", cta: "Upgrade to StatZ", to: "membership" },
