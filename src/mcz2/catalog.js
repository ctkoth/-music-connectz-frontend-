...
export const CATALOG = [
  ...
  },
  {
    ...
    apps: [
      ...
      { key: "bugz", name: "BugZ", emoji: "🐞", icon: "bugz.png", desc: "Submit a bug as a post. Admins mark it In Progress 💭 or Squashed 🪦 (which rewards you 200 SpinAZ).", fn: true },
  ...
  },
  {
    ...
    apps: [
      ...
      { key: "bassz", name: "BassZ", emoji: "🎸", icon: "bassz.png", desc: "Bass training — groove, fingerstyle, slap, locking in.", fn: true },
      ...
      { key: "moodz", name: "MoodZ", emoji: "😅", icon: "moodz.png", desc: "The mood you were in when posting — tracked and filterable across the platform.", fn: true },
