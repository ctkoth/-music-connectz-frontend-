...
const QuestZ = lazy(lazyRoute(() => import("./apps/QuestZ.jsx")));
...
export const CUSTOM_ICONS = {
  ...
  // Generated by tools/make-neon-icons.mjs — QuestZ had no artwork because it
  // had no tab. Edit the glyph there, never this SVG.
  "questz.png": "/icons/questz-neon.svg",
...
const TABS = [
  ...
  { key: "questz", label: "QuestZ", icon: "questz.png", el: <QuestZ /> },
